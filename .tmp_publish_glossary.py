...
slug="2026-04-07-cartpole-rl-glossary-dialogue"
title="CartPole、强化学习与 Isaac Lab 词汇双人播客"
summary="基于词汇表制作的双人中文技术播客。每人负责一个词，保留英文词的发音与拼写提示，主体解释全部用中文，帮助熟悉 CartPole、强化学习和 Isaac Lab 相关术语。"
