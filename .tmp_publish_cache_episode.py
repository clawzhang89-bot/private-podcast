...
slug="2026-04-08-cache-mechanism-gemma4-claude-code-single-male"
title="缓存机制技术讲解：从 Gemma4 到 Claude Code 为什么能省 Token"
summary="围绕 X 上文章主题做的一期单男声技术播客，重点讲清大模型系统中的 KV cache、prompt caching、agent 状态缓存，以及为什么缓存能显著降低 token 成本与延迟。"
