...
slug="2026-04-07-isaac-lab-dev-single-male"
title="Isaac Lab 开发技术讲解：从项目生成到关节定义与最小训练"
summary="一段偏技术向、适合开发者收听的中文长音频，系统讲解 Isaac Lab 的项目结构、Articulation、Joint、Actuator、Direct RL 环境与最小训练路径。"
